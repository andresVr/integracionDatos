...
select SUM(CANTIDAD) FROM datawarehouse.FAC_DETALLE_FACTURA WHERE ID_FECHA BETWEEN 336 AND 366;
select SUM(CANTIDAD) FROM datawarehouse.FAC_DETALLE_FACTURA_MENSUAL WHERE ID_FECHA = 336;
...
DELETE from control.TMP_FECHA_CARGA;
